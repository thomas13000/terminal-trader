...
# ---------------------------------------------------------
# COMPOSANT HTML 3D AUTONOME + WEBSOCKET TRADINGVIEW TEMPS RÉEL
# ---------------------------------------------------------
def render_3d_welcome_overlay():
    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; user-select: none; }
            ...
            /* --- PANNEAU LATÉRAL : PRICING WEBSOCKET TRADINGVIEW --- */
            .side-panel {
                position: relative;
                z-index: 2;
                display: flex;
    ...
    <div id="welcome-screen-root" onclick="dismissOverlay()">
        ...
        <!-- CÔTÉ DROIT : PRIX TEMPS RÉEL (WEBSOCKET TRADINGVIEW) -->
        <div class="side-panel" onclick="event.stopPropagation()">
            <div class="side-panel-header">⚡ MARCHÉS TEMPS RÉEL (TICK BY TICK)</div>
    ...
    <script>
        // --- 1. Ajustement Plein Écran de l'iframe Streamlit ---
        function expandIframeToFullscreen() {
            try {
                ...
                console.log("Plein écran autonome actif");
            }
        }
        expandIframeToFullscreen();

        // --- 2. Déverrouillage d'Accès au Clic ---
